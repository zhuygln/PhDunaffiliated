...
Writing-only knowledge base for an independent, unaffiliated PhD journey in AI. No runnable code lives here — all code is in separate repositories and linked from documents in this repo.
...
qualification/      # Phase 1 (ACTIVE): learning, paper notes, area surveys, exploratory projects
  ...
  projects/         # Exploratory research attempts (link to external code repos)
  self-assessment.md
preliminary/        # Phase 2 (future placeholder)
defense/            # Phase 3 (future placeholder)
network/            # Cross-phase: researcher contacts, collaborations, outreach, reviewer candidates
publications/       # Cross-phase: paper submission pipeline tracker
visualization/      # Future: personal website and research showcase design
roadmap.md          # Phase milestones, timeline, decision log
onenote.md          # Quick-capture inbox — unclassified notes pending triage
```
