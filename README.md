...
publications/       # Ongoing — paper submission pipeline
visualization/      # Future — personal website and research showcase design
roadmap.md          # Phase milestones, timeline, decision log
onenote.md          # Quick-capture inbox for unclassified notes
```

## Progress Tracking

Granular tasks are tracked in [GitHub Projects](../../projects) (Issues/milestones).
High-level phase gates and decisions live in [`roadmap.md`](roadmap.md).
